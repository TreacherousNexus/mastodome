...
class MainWindow(object):
    ...
    def __init__(self, main_window):
        ...
        self.plainTextTootBox = QtGui.QPlainTextEdit(self.verticalLayoutWidget)
        ...
        self.vLayoutTootBtn = QtGui.QVBoxLayout()
        self.vLayoutTootBtn.setObjectName(_fromUtf8("vLayoutTootBtn"))
        self.btnToot = QtGui.QPushButton(self.verticalLayoutWidget)
        ...
        self.vLayoutPanelOpts = QtGui.QVBoxLayout()
        ...
        self.vLayoutCentreColumn = QtGui.QVBoxLayout(self.verticalLayoutWidget_6)
        self.vLayoutCentreColumn.setMargin(5)
        self.vLayoutCentreColumn.setObjectName(_fromUtf8("vLayoutCentreColumn"))
        self.listOfToots = QtGui.QListView(self.verticalLayoutWidget_6)
        ...
        self.vLayoutRightColumn = QtGui.QVBoxLayout(self.verticalLayoutWidget_7)
        self.vLayoutRightColumn.setMargin(5)
        self.vLayoutRightColumn.setObjectName(_fromUtf8("vLayoutRightColumn"))
        self.listOfNotifications = QtGui.QListView(self.verticalLayoutWidget_7)
